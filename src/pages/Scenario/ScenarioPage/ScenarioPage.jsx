      ...
      <div className="flex-1 h-28">
        <div className="flex flex-row text-justify relative">
          <h2 className="text-3xl flex flex-row ml-2 font-normal">
            Prompt automation |<p className="text-lightPurple ml-2"></p>
          </h2>
        </div>
      </div>
      <div className="flex flex-row gap-4">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col xl:flex-col mt-5 gap-5 w-[100%] h-[100%]">
            <p className="text-xl text-white text-justify">Prompts</p>
            <div className="flex flex-row rounded-md bg-purpleBlue w-[100%] h-80 xl:h-[500px]">
              <div className="table">
...
New Scenario
        ...
        <div className="flex-1 items-center bg-purpleBlue rounded-lg p-5 text-xl text-creme">
