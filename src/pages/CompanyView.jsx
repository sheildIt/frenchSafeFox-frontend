      ...
      <div className="flex flex-col items-center justify-center p-10">
        ...
        <div className="flex flex-row p-10 border rounded-lg w-full">
          <div className="max-w-sm bg-gray-800 border border-gray-200 rounded-lg ml-3 w-36 h-40 shadow dark:bg-gray-800 dark:border-gray-700 hover:bg-sky-900 duration-300 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              onClick={openCompanyRegModal}
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              stroke="currentColor"
              className="w-10 h-10 text-white mx-auto mt-14"
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <ul className="flex flex-row">
            {companies?.map((company) => {
              return (
                <div
                  key={company.id}
                  className="max-w-sm bg-gray-800 border border-gray-200 rounded-lg ml-3 w-36 h-40 shadow dark:bg-gray-800 dark:border-gray-700"
                >
                  <div className="p-5">
                    <a href="#">
