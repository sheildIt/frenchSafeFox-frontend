...
const LoginPage = () => {
  ...
  return (
    <section className="bg-mainColor dark:bg-mainColor">
      <div className="flex flex-col items-center justify-center px-6 mx-auto mt-20">
        <div className="w-full bg-gray-800 rounded-lg shadow border-gray-700 md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
