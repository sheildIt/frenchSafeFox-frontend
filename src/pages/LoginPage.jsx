...
<<<<<<< HEAD
    <section className="">
      <div className="flex flex-col items-center justify-center px-6 mx-auto mt-20">
        <div className="w-full bg-gray-700 rounded-lg shadow border-gray-700 md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
=======
...
>>>>>>> 571fc8f0b884d6136bcd610d3a235fc327e227f0
